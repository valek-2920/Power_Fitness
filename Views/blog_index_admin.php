...
<head>
    ...
    <title>PowerFitness | Blogs</title>
...
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-6 col-sm-6">
                <h1>Blogs del Sistema</h1>
            </div>
            <div class="col-md-12 col-sm-12">
                <div class="pull-right">
                    <a href="create_blog.php"><i class="fa fa-plus"></i> Crear</a>
                </div>
                <div class="x_panel">
                    <div class="x_content">
                        <div class="row">
    ...
    <script src="js/funciones/funcionesBlogs.js"></script>
