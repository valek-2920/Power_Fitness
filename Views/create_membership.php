                                ...
                                <div class="x_content">
                                    ...
                                    <form action="" method="post" class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <textarea rows="3" cols="20" id="descripcion" name="descripcion" required class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 offset-md-3">
                                                <input class="btn btn-primary" type="submit" value="Crear Membresía" id="btnCrearMembresia" name="btnCrearMembresia">
                                            </div>
                                        </div>
                                    </form>
                                </div>
