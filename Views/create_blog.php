                                ...
                                <div class="x_content">
                                    ...
                                    <form action="" method="post" class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <textarea rows="5" cols="50" id="contenido" name="contenido" required class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="ln_solid"></div>
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 offset-md-3">
                                                <input class="btn btn-primary" type="submit" value="Crear Blog" id="btnCrearBlog" name="btnCrearBlog">
                                            </div>
                                        </div>
                                    </form>
                                </div>
